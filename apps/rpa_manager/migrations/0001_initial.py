# Generated by Django 3.2.8 on 2023-07-10 13:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Criado')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Atualizado')),
                ('nome_piloto_maior_numero_missoes', models.CharField(max_length=200)),
                ('numero_piloto_maior_numero_missoes', models.IntegerField()),
                ('opm_maior_numero_apoios', models.CharField(max_length=200)),
                ('numero_opm_maior_numero_apoios', models.IntegerField()),
            ],
            options={
                'abstract': False,
            },
