...
class PersonCortex(Base, SoftDelete):
    ...
    anoExercicioOcupacao = models.CharField(
    ...
    complementoLogradouro = models.CharField(
    ...
    indicadorEstrangeiro = models.CharField(
        max_length=50, null=True, blank=True)
    dataAtualizacao = models.CharField(max_length=50, null=True, blank=True)
    ...
    municipioNaturalidade = models.CharField(
        max_length=255, null=True, blank=True)
...
class RegistryCortex(Registry):
    person_cortex = models.ForeignKey(
        PersonCortex, related_name='registers', on_delete=models.CASCADE)
