# Generated by Django 3.2.8 on 2023-11-07 04:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('security_cameras_rec', models.BooleanField()),
                ('private_security', models.BooleanField()),
                ('external_lights', models.BooleanField()),
                ('alarm_system', models.BooleanField()),
                ('fire_extinguisher', models.BooleanField()),
                ('emergency_out', models.BooleanField()),
                ('fire_alarm_system', models.BooleanField()),
                ('security_barriers', models.BooleanField()),
                ('other_security_measures', models.TextField(blank=True, null=True)),
                ('score', models.IntegerField(blank=True, null=True)),
                ('spot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='security_survey', to='protect_network.spot')),
            ],
        ),
        migrations.CreateModel(
            name='OpeningHours',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpf', models.CharField(blank=True, default='', max_length=14, null=True, verbose_name='CPF')),
                ('spot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='protect_network.spot')),
            ],
        ),
    ]
