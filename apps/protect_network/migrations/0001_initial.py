# Generated by Django 3.2.8 on 2023-10-11 00:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spot_type_father', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='spot_type_son', to='point_interest.spottype', verbose_name='Categoria Pai')),
            ],
        ),
        migrations.CreateModel(
            name='SpotAddresses',
            fields=[
                ...
                ('spot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='point_interest.spot')),
            ],
        ),
        migrations.AddField(
            model_name='spot',
            name='addresses',
            field=models.ManyToManyField(through='point_interest.SpotAddresses', to='address.Address'),
        ),
        migrations.AddField(
            model_name='spot',
            name='created_by',
        ...
        migrations.AddField(
            model_name='spot',
            name='spot_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='point_interest.spottype'),
        ),
        migrations.AddField(
            model_name='spot',
            name='tags',
            field=models.ManyToManyField(blank=True, to='point_interest.Tag'),
        ),
        migrations.AddField(
            model_name='spot',
            name='updated_by',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='opening_hours', to='point_interest.spot')),
            ],
        ),
        migrations.CreateModel(
            name='Image',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Criado')),
                ('imageSpot', stdimage.models.StdImageField(storage=django_minio_backend.models.MinioBackend(bucket_name='bacinf-media'), upload_to='point_interest_img', verbose_name='Imagem')),
