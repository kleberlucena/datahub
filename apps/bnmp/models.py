...
class PersonBNMP(Base, SoftDelete):
    ...
    dataNascimento = models.CharField(max_length=50, null=True, blank=True)
...
class MandadoPrisao(Base, SoftDelete):
    ...
    dataCriacao = models.CharField(max_length=50, null=True, blank=True)
    ...
    textoJustificativaCancelamento = models.CharField(
        max_length=255, null=True, blank=True)
    dataConfirmacaoServidor = models.CharField(
        max_length=50, null=True, blank=True)
    dataExpedicao = models.CharField(max_length=50, null=True, blank=True)
    dataConclusao = models.CharField(max_length=50, null=True, blank=True)
    dataExpiracaoPrisaoMandadoPrisao = models.CharField(
        max_length=50, null=True, blank=True)
    dataVencimentoMandados = models.CharField(
        max_length=50, null=True, blank=True)
    orgaoJudiciario = models.CharField(max_length=255, null=True, blank=True)
    dataValidade = models.CharField(max_length=50, null=True, blank=True)
    ...
    descricaoJustificativa = models.CharField(
        max_length=255, null=True, blank=True)
    nomeEstabelecimentoPrisional = models.CharField(
        max_length=255, null=True, blank=True)
    dataPrisao = models.CharField(max_length=50, null=True, blank=True)
    ...
    person_bnmp = models.ForeignKey(
        PersonBNMP, related_name='mandados', on_delete=models.CASCADE, null=True, blank=True)
...
class RegistryBNMP(Registry):
    person_bnmp = models.ForeignKey(
        PersonBNMP, related_name='registers', on_delete=models.CASCADE)
