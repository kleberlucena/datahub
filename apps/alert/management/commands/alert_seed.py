...
class Command(BaseCommand):
    ...
    def create_groups(self):
        ...
        groups_to_create = {
            ...
            "profile:alert_basic": [],  # TODO: Adicione as permissões para alert_basic aqui
            "profile:alert_create": [
                'add_alertcortex', 
                'add_personalertcortex', 
                'add_vehiclealertcortex'
            ],
            "profile:alert_intermediate": [
                'view_alertcortex',
                'view_vehiclealertcortex'
            ]
        }
        ...
        models_to_get = [models.AlertCortex, models.VehicleAlertCortex, models.PersonAlertCortex]
