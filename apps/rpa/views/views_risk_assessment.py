...
from apps.rpa.models import RiskAssessment, Assessment
from apps.rpa.forms import RiskAssessmentForm, AssessmentForm
...
class RiskAssessmentListView(ListView):
    ...
    template_name = 'rpa/list_risks_analysis.html'  
...
class RiskAssessmentDetailView(DetailView):
    model = RiskAssessment
    template_name = 'rpa/detail_risk_assessment.html'
...
class RiskAssessmentCreateView(GroupRequiredMixin, CreateView):
    ...
    template_name = 'rpa/create_risk_assessment.html'
    success_url = reverse_lazy('rpa:create_assessment')
...
class RiskAssessmentUpdateView(GroupRequiredMixin, UpdateView):
    model = RiskAssessment
    template_name = 'rpa/update_risk_assessment.html'
    form_class = RiskAssessmentForm
    success_url = reverse_lazy('rpa:risk_assessment_list')
    group_required = ['profile:rpa_basic', 'profile:rpa_advanced']
...
class RiskAssessmentDeleteView(GroupRequiredMixin, DeleteView):
    model = RiskAssessment
    template_name = 'rpa/delete_risk_assessment.html'
...
class CreateAssessmentByRiskView(View):
    template_name = 'rpa/create_assessment.html'
    ...
    def post(self, request, risk_assessment_id):
        ...
        if form.is_valid():
            ...
            return redirect('rpa:read_risk_assessment', pk=risk_assessment_id)
...
class AssessmentUpdateView(GroupRequiredMixin, UpdateView):
    model = Assessment
    template_name = 'rpa/update_assessment.html'
    form_class = AssessmentForm
    success_url = reverse_lazy('rpa:risk_assessment_list')
    group_required = ['profile:rpa_basic', 'profile:rpa_advanced']
    ...
    def form_valid(self, form):
        ...
        redirect_url = reverse('rpa:read_risk_assessment', kwargs={'pk': risk_assessment_pk})
...
class AssessmentDeleteView(GroupRequiredMixin, DeleteView):
    model = Assessment
    template_name = 'rpa/delete_assessment.html'
    context_object_name = 'obj'
    pk_url_kwarg = 'pk'
    success_url = reverse_lazy('rpa:risk_assessment_list')
    group_required = ['profile:rpa_basic', 'profile:rpa_advanced']
...
class RiskAssessmentPDFDetailView(DetailView):
    model = RiskAssessment
    template_name = 'rpa/generate_risk_asssessment_pdf.html'
...
def duplicate_risk_assessment(request, risk_assessment_id):
    ...
    return redirect('rpa:update_risk_assessment', pk=new_risk_assessment.id)
