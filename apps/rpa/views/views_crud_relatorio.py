...
from apps.rpa.utils.createJsonByLastReport import createJsonByLastReport
...
class VerRelatorioView(GroupRequiredMixin, DetailView):
    model = Report
    template_name = 'rpa/detail_report.html'
...
class CriarNovoRelatorioView(GroupRequiredMixin, CreateView):
    ...
    template_name = 'rpa/create_report.html'
    success_url = reverse_lazy('rpa:add_point')
...
class EditarRelatorioView(GroupRequiredMixin, UpdateView):
    model = Report
    form_class = ReportForm
    template_name = 'rpa/update_report.html'
    success_url = reverse_lazy('rpa:relatorios')
    context_object_name = 'relatorio'
...
class DeletarRelatorioView(GroupRequiredMixin, DeleteView):
    model = Report
    template_name = 'rpa/delete_report.html'
    success_url = reverse_lazy('rpa:relatorios')
