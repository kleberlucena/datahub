...
from apps.rpa.utils.saveNewChecklistInAircraftHistoric import saveNewChecklistInAircraftHistoric
from apps.rpa.utils.getLastRegisteredChecklistData import getLastRegisteredChecklistData
...
class VerChecklistView(GroupRequiredMixin, DetailView):
    model = Checklist
    template_name = 'rpa/detail_checklist.html'
...
class ChecklistFormView(GroupRequiredMixin, View):    
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'rpa/create_checklist.html', context)
    ...
    def post(self, request):
        ...
        if checklist_form.is_valid():
            ...
            return redirect('rpa:update_all_batteries')
...
class EditarChecklistView(GroupRequiredMixin, UpdateView):
    ...
    template_name = 'rpa/update_checklist.html'
    success_url = reverse_lazy('rpa:checklists')
...
class DeletarChecklistView(GroupRequiredMixin, DeleteView):
    model = Checklist
    template_name = 'rpa/delete_checklist.html'
    success_url = reverse_lazy('rpa:checklists')
...
class ChecklistImageDeleteView(DeleteView):
    ...
    template_name = 'rpa/delete_image_checklist.html'
    success_url = reverse_lazy('rpa:checklists')
