    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aircraft', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rpa.aircraft')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('probability', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rpa.probability')),
                ('severity', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rpa.severity')),
            ],
        ),
        migrations.CreateModel(
            name='RiskAssessment',
            fields=[
                ...
                ('aircrafts', models.ManyToManyField(to='rpa.Aircraft')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aircraft', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rpa.aircraft')),
                ('entity_support', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rpa.entities')),
                ('flight_nature', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rpa.flightnature')),
                ('location', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rpa.citiespb')),
                ('observer_pilot', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='report_observer_pilot', to='portal.military')),
                ...
                ('type_of_operation', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rpa.typesofoperations')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('driver', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='gu_driver', to='portal.military')),
                ('entity', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='police_group', to='portal.entity')),
                ('location', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rpa.citiespb')),
                ('observer_pilot', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='gu_observer_pilot', to='portal.military')),
                ('remote_pilot', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='gu_remote_pilot', to='portal.military')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operation', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rpa.report')),
            ],
        ),
        migrations.CreateModel(
            name='Operation',
            fields=[
                ...
                ('aircraft', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rpa.aircraft')),
                ('location', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rpa.citiespb')),
                ('observer_pilot', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='operation_observer_pilot', to='portal.military')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('incident', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rpa.incidents')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checklist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rpa.checklist')),
            ],
        ),
        migrations.CreateModel(
            name='Battery',
            fields=[
                ...
                ('aircraft', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rpa.aircraft')),
                ('maximum_cicles', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rpa.typeofbattery')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('probability_of_occurrence', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rpa.probability')),
                ('risk_assessment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='rpa.riskassessment')),
                ('severity_of_occurrence', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rpa.severity')),
                ('situation', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rpa.situation')),
            ],
        ),
        migrations.AddField(
            model_name='aircraft',
            name='location',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rpa.citiespb'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(default=apps.rpa.models.generate_hex_code, max_length=25, unique=True)),
                ('num_propellers', models.IntegerField(default=4)),
                ('num_batteries', models.IntegerField(default=4)),
                ('batteries_loaded', models.BooleanField(default=True)),
                ('control_battery_loaded', models.BooleanField(default=True)),
