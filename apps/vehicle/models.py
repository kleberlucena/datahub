...
class VehicleCortex(Base, SoftDelete):
    ...
    dataPreCadastro = models.DateField(null=True, blank=True)
    dataEmplacamento = models.DateTimeField(null=True, blank=True)
    chassi = models.CharField(max_length=30, null=True, blank=True)
    identificadorUnicoVeiculo = models.CharField(max_length=30, null=True, blank=True)
    tipoDocumentoFaturado = models.CharField(max_length=30, null=True, blank=True)
    mesFabricacaoVeiculo = models.CharField(max_length=30, null=True, blank=True)
    ufDestinoVeiculoFaturado = models.CharField(max_length=30, null=True, blank=True)
    ...
    ufJurisdicaoVeiculo = models.CharField(max_length=20, null=True, blank=True)
    ...
    descricaoOrgaoRegiaoFiscal = models.CharField(max_length=255, null=True, blank=True)
    ...
    dataEmissaoCRLV = models.DateTimeField(null=True, blank=True)
    ...
    valorIPVA = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    dataAtualizacaoVeiculo = models.DateField(null=True, blank=True)
    ...
    quantidadeRestricoesBaseEmplacamento = models.CharField(max_length=50, null=True, blank=True)
    ...
    dataReplicacao = models.DateTimeField(null=True, blank=True)
