...
urlpatterns = [
    ...
    path('api/v1/bnmp/', include('apps.bnmp.api.v1.urls'), name='bnmp_api'),
    path('api/v1/cortex/', include('apps.cortex.api.v1.urls'), name='cortex_api'),
    ...
    path('api/v1/portal/', include('apps.portal.api.v1.urls'), name='portal_api'),
    ...
    path('georeference/', include('apps.georeference.urls'), name='georeference'),
