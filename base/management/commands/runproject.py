...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        # os.system(["python", "manage.py", "runserver", f"{settings.PROJECT_PORT}"], capture_output=True,)
        # print(os.popen(f"python manage.py runserver {settings.PROJECT_PORT}").read())
